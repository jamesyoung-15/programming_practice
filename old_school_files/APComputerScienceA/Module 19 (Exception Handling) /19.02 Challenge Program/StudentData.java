...
/**
 * Purpose: provide student data in which their first and last names must be provided along with valid assignment scores
 *
 * @author (James Young)
 * @version (April 6)
 */
public class StudentData
{
    ...
    {
        String str = String.format("\n %-5s %-5s", getName(), getLast());
        String a = str + "  -  " + getGrade() + " : " + scoresString(scores);
        return a;
    }
