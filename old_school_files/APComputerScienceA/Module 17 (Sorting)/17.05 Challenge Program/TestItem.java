...
public class TestItem
{
    ...
    {
        Item pencil = new Item("1011","Pencil",200,10.5);
        Item pen = new Item("1034","Pen",60,21.5);
        Item paper = new Item("1101","Paper",90,9.99);
        Item eraser = new Item("1600","Eraser",80,19.99);
        Item whiteout = new Item("1500","White Out",100,59);
        Item scissors = new Item("1201","Scissors",55,80);
        Item[] items = new Item[] {pencil, pen, paper,
                                    eraser, scissors, whiteout};
